...
const defaultLayouts = {
  ...
  "Teal 74.75": {
    "sizes": { "initial": 0.45, "final": 0.171, "ratio": 0.871 },
    "circles": {
        "one": { "cx": 0, "cy": -27.5, "r": 22.5, "fill": "#840"
      },
      "two": {
        "cx": -30.34, "cy": 1.886, "r": 19.601, "fill": "#880"
      },
      "three": {
        "cx": -8.641, "cy": 31.77, "r": 17.075, "fill": "#090"
      },
      "four": {
        "cx": 12.493, "cy": 7.806, "r": 14.875, "fill": "#066"
      },
      "five": {
        "cx": 36.499, "cy": -6.312, "r": 12.958, "fill": "#048"
      },
      "six": {
        "cx": 19.953, "cy": 33.171, "r": 11.289, "fill": "#009"
      },
      "seven": {
        "cx": 36.473, "cy": 16.82, "r": 9.834, "fill": "#408"
      },
      "eight": {
        "cx": 31.232, "cy": -27.224, "r": 8.567, "fill": "#804"
      }
    },
    "coverage": "74.752%"
},
